...
class FilesApi(object):
    ...
    def files_upload_multiple_view(self, **kwargs):  # noqa: E501
        """Files Upload Multiple View  # noqa: E501

        Web form to upload files at http://localhost:8000/v0/files/upload-form-view  Overcomes limitation of Swagger UI view NOTE: As of 2020-10-07, Swagger UI doesn't support multiple file uploads in the same form field  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_upload_multiple_view(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.files_upload_multiple_view_with_http_info(**kwargs)  # noqa: E501

    def files_upload_multiple_view_with_http_info(self, **kwargs):  # noqa: E501
        """Files Upload Multiple View  # noqa: E501

        Web form to upload files at http://localhost:8000/v0/files/upload-form-view  Overcomes limitation of Swagger UI view NOTE: As of 2020-10-07, Swagger UI doesn't support multiple file uploads in the same form field  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_upload_multiple_view_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method files_upload_multiple_view" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            '/v0/files/upload-multiple-view', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_files(self, **kwargs):  # noqa: E501
        ...
        Lists all user's files   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
